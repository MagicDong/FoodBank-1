...
@interface ZDGuoMinController () <UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIAlertViewDelegate>
...
@implementation ZDGuoMinController
