...
@interface ZDAnQuanController () <UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIAlertViewDelegate>
...
@implementation ZDAnQuanController
