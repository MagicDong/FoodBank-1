...
@interface ZDJuJueViewController ()<UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation ZDJuJueViewController
