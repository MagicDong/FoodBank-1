...
@interface ZDWeiChangShiController () <UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIAlertViewDelegate>
...
@implementation ZDWeiChangShiController
